...
//
// 异常保证：
// ccystl::unordered_set<Key> / ccystl::unordered_multiset<Key>
...
template <class Key, class Hash = ccystl::hash<Key>,
...
class unordered_set {
 ...
 public:
  ...
  unordered_set(unordered_set&& rhs) noexcept : ht_(ccystl::move(rhs.ht_)) {}
